### CÓDIGO FINAL E COMPLETO (v49 - PARA RENDER) ###
...
def scan_market():
    # Watchlist otimizada para o plano gratuito da Render
    watchlist = [
        ...
        "ETC-USD", "ICP-USD", "HBAR-USD", "VET-USD", "FIL-USD", "APT-USD", "CRO-USD", "ARB-USD", "OP-USD", "INJ-USD"
    ]
...
@app.route('/')
def health_check():
    return "Servidor de análise v47 a funcionar!"
