### CÓDIGO FINAL (v45 - PARA RENDER COM SISTEMA DE PONTUAÇÃO) ###
...
def analisar_ativo_mtf(ticker):
    try:
        ...
        SCORE_MINIMO_SETUP = 2 # Limiar para ser considerado um setup de alta confluência
        
        setup_principal = setups_encontrados[0] # Pega o primeiro como base
...
def scan_market():
    ...
    ] # Lista curta para um teste rápido
